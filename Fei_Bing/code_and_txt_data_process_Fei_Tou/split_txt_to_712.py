...
# # 替换为实际的文件路径
# txtA_path =  '/mnt/sdd/yrh/Fei_Bing/code_and_txt_data_process_Fei_Tou/total.txt'
# train_path = '/mnt/sdd/yrh/Fei_Bing/code_and_txt_data_process_Fei_Tou/train.txt'
# val_path =   '/mnt/sdd/yrh/Fei_Bing/code_and_txt_data_process_Fei_Tou/val.txt'
# test_path =  '/mnt/sdd/yrh/Fei_Bing/code_and_txt_data_process_Fei_Tou/test.txt'
...
if __name__ == "__main__":
    total_txt = '/mnt/sdd/wjh/Fei_Bing/code_and_txt_data_process_Fei_Tou/total.txt'
    save_dir = '/mnt/sdd/wjh/Fei_Bing/code_and_txt_data_process_Fei_Tou/kfold_splits'  # 当前目录下新建
