...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        ...
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            # total_labels_per_class = torch.Tensor([672, 178,195,158,19]).cuda()
            ...
            # criteria = nn.CrossEntropyLoss()
            # loss = criteria(outputs[:], label_batch[:][:].long())
    ...
    # model_path_best = "/mnt/sdd/wjh/Fei_Bing/model/experiment/第一阶段Fei_Tou_ResNet_Acc_6081_PPV_8860_SEN_6422/DenseNet_5_class_Fei_Tou_best_model.pth"
