...
def train(args, snapshot_path):
    ...
    for epoch_num in iterator:
        for i_batch, sampled_batch in enumerate(trainloader):
            ...
            # 损失一致性，判断的依据也应该相同
            # 对于student和teacher网络都进行的操作，用预测图进行backward，
            ...
            if iter_num > 0 and iter_num % 200 == 0:
                ...
                writer.add_scalar('info/val_mean_PPV', PPV, iter_num)
                writer.add_scalar('info/val_mean_SEN', SEN, iter_num)
    ...
    print('test_dice : %f test_hd95 : %f' % (performance, mean_hd95)) 
    logging.info('test_dice : %f test_hd95 : %f' % (performance, mean_hd95))     
    #最后的拼接步骤
