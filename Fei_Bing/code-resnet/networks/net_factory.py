...
from networks.unet import UNet, UNet_DS, UNet_URPC, UNet_CCT, unet_feature_away, unet_nodrop, unet_change_skip_concat, DenseNet, DenseNet_2_class
import argparse
...
def net_factory(net_type="unet", in_chns=1, class_num=3):
    ...
    elif net_type == "unet_feature_away":
        net = unet_feature_away(in_chns=in_chns, class_num=class_num).cuda()
    elif net_type == "unet_nodrop":
        net = unet_nodrop(in_chns=in_chns, class_num=class_num).cuda()
    elif net_type == "unet_change_skip_concat":
        net = unet_change_skip_concat(in_chns=in_chns, class_num=class_num).cuda()
    elif net_type == "DenseNet":
        net = DenseNet(in_chns=in_chns, num_classes=class_num).cuda()
    elif net_type == "DenseNet_2_class":
        net = DenseNet_2_class(in_chns=in_chns, num_classes=class_num).cuda()
    elif net_type == "DenseNet_5_class_Fei_Tou":
        net = DenseNet_2_class(in_chns=in_chns, num_classes=class_num).cuda()
    elif net_type == "enet":
