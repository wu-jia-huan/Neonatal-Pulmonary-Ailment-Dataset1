...
def print_parameters_3(model, ema_model, break_layer, break_ratio):
    
    for name, param in model.named_parameters():
        if name == 'encoder.down3.maxpool_conv.1.conv_conv.0.weight':
            print('param encoder', param)
        if name == 'decoder.up2.conv.conv_conv.0.weight':
            print('param decoder', param)
...
def train(args, snapshot_path):
    ...
    save_best_model = '/mnt/sdd/yrh/code_star/0313_change_and_test_ACDC/pth/Cocoon_num1_lr0.9_0.1_7_labeled_DSC_8848_PPV_8814_SEN_8957_DH95_4.3986_DH_21.178_iou_7999_boundary_iou_0.4712/iter_14800_dice_0.8744.pth'
    skip_concat = True
    ...
    # 交换权重之前输出一下相关位置的参数，交换之后在输出一下，确保交换
    print_parameters_3(model, ema_model, args.break_layer, args.break_ratio)
